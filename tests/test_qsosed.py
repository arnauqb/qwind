...
def test_initial_parameters():
    testing.assert_approx_equal(
        radiation.wind.r_in, 8.901985418630156)
    testing.assert_approx_equal(
        radiation.wind.r_out, 1354.415129, significant=6)
    testing.assert_approx_equal(radiation.r_x, 230.06817351643767)
    testing.assert_approx_equal(
        radiation.uv_fraction, 0.7104113267357257)
    testing.assert_approx_equal(
        radiation.xray_fraction, 0.13260254529361606)
    testing.assert_approx_equal(
        radiation.force_radiation_constant, 0.994718394324346)
    testing.assert_approx_equal(
        radiation.wind.eddington_luminosity, 2.51413032723893e46, significant=6)
    testing.assert_approx_equal(
        radiation.xray_luminosity, 0.5 *
        radiation.xray_fraction * radiation.wind.eddington_luminosity,
        significant=6)
...
def test_optical_depth_x():
    ...
    tau_truth = tau_dr_0 * (radiation.r_x - radiation.wind.r_in)
